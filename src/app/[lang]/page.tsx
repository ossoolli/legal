    ...
    <div className="flex flex-col w-full">
      ...
      <section className="bg-burgundy text-cream py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 flex flex-col items-center">
          ...
          <span className="w-12 h-[1px] bg-roseGray/30 my-6" />
          ...
          <p className="font-cairo text-sm text-roseGray leading-relaxed max-w-xl mb-10">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <a
              ...
              className="p-6 rounded border border-cream/10 hover:border-burgundy bg-charcoal hover:bg-burgundy/5 transition-all flex flex-col items-center gap-3 cursor-pointer group"
            >
